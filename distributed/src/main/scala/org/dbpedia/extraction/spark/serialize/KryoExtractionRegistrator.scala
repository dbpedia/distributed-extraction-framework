...
class KryoExtractionRegistrator extends KryoRegistrator
{
  ...
  {
    kryo.register(Class.forName("org.dbpedia.extraction.mappings.DistRedirects$RedirectFinder"))
    ...
    kryo.register(classOf[org.dbpedia.extraction.dump.extract.ExtractorMapper])
